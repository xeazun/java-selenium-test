...
public class UITestService {
    ...
    private AdminConstant _adminUser;
    private CommonConstant _commonConstant;
    private UserConstant _userConstant;
    private ApproverConstant _approverConstant;
    ...
    public void DocumentDropDown(String elementId, int durationTime) {
        for (int i = 1; i <= 2; i++) {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(durationTime * 2));
...
//        driver.findElement(By.xpath(elementId)).click();
            ...
            Select selectCenter = new Select(dropdownCenter);
            List<WebElement> optionsCenter = selectCenter.getOptions();
            WebElement lastOption = optionsCenter.get(optionsCenter.size() - 2);
            selectCenter.selectByValue(lastOption.getAttribute("value"));
...
//            driver.findElement(By.xpath(elementId)).click();
//
//            WebElement dropdownCenterTwo = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(elementId)));
//            Select selectCenterTwo = new Select(dropdownCenterTwo);
//            List<WebElement> optionsCenterTwo = selectCenterTwo.getOptions();
//            WebElement lastOptionTwo = optionsCenterTwo.get(optionsCenterTwo.size() - 3);
//            selectCenterTwo.selectByValue(lastOptionTwo.getAttribute("value"));
//
//            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(_commonConstant.modalSaveButtonXpath)));
//            driver.findElement(By.xpath(_commonConstant.modalSaveButtonXpath)).click();
//
//
//            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(_commonConstant.notificationSuccessStateTextXpath)));
//            WebElement notificationTrueTwo = driver.findElement(By.xpath(_commonConstant.notificationSuccessStateTextXpath));
//
//            String notificationTrueTextTwo = notificationTrue.getText();
//            System.out.println("Notification text: " + notificationTrueText);
//
//            driver.findElement(By.xpath(_commonConstant.notificationCloseButtonXpath)).click();
        }
